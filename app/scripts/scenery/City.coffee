...
generator.defineElement 'water', ->
  @addBackground(0, @level.visibleHeight - 125, Crafty.e('2D, WebGL, Image').image('images/water.png').attr(z: -500), .5)

generator.defineElement 'waterFront', ->
  height = 65
  @add(0, @level.visibleHeight - 10, Crafty.e('2D, Solid').attr(w: @delta.x, h: 10))
  @add(0, @level.visibleHeight - height, Crafty.e('2D, WebGL, Image').image('images/water-front.png').attr(z: -300))
