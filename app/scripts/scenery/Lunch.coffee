...
generator.defineBlock class extends @Game.LevelScenery
  ...
  generate: ->
    super
    @addBackground(380, @level.visibleHeight - 180, Crafty.e('2D, WebGL, Color').color('#505050').attr({ z: -1, w: 40, h: 180 }), .5)
    @addBackground(380, @level.visibleHeight - 90, Crafty.e('2D, WebGL, Color').color('#606060').attr({ z: -2, w: 40, h: 90 }), .25)
    @addBackground(380, @level.visibleHeight - 360, Crafty.e('2D, WebGL, Color').color('#303030').attr({ z: 2, w: 40, h: 360 }), 1.5)
    ...
    @add(380, 0, Crafty.e('2D, WebGL, Color').color('#202020').attr({ z: -1, w: @delta.x - 380, h: @level.visibleHeight }))
...
generator.defineBlock class extends @Game.LevelScenery
  ...
  generate: ->
    ...
    @addBackground(380, @level.visibleHeight - 360, Crafty.e('2D, WebGL, Color').color('#303030').attr({ z: 2, w: 40, h: 360 }), 1.5)
    @addBackground(380, @level.visibleHeight - 180, Crafty.e('2D, WebGL, Color').color('#505050').attr({ z: -1, w: 40, h: 180 }), .5)
    @addBackground(380, @level.visibleHeight - 90, Crafty.e('2D, WebGL, Color').color('#606060').attr({ z: -1000, w: 40, h: 90 }), .25)
    ...
    @add(0, 0, Crafty.e('2D, WebGL, Color').color('#202020').attr({ z: -1, w: 380, h: @level.visibleHeight }))
