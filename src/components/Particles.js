...
import colorFragmentShader from "./shaders/particle.frag";
import colorVertexShader from "./shaders/particle.vert";
import { lookup } from "src/lib/random";

Crafty.defaultShader(
  "Particle",
  new Crafty.WebGLShader(
    //fs.readFileSync(__dirname + '/shaders/particle.vert', 'utf8'),
    //fs.readFileSync(__dirname + '/shaders/particle.frag', 'utf8'),
    colorVertexShader,
    colorFragmentShader,
    [
