...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    coffee: {
      compile: {
        files: {
          '<%= yeoman.app %>/scripts/compiled/lib.js': [
            '<%= yeoman.app %>/scripts/lib/script_modules/*.*coffee',
            '<%= yeoman.app %>/scripts/lib/script_templates/*.*coffee',
            '<%= yeoman.app %>/scripts/lib/*.*coffee'
          ],
